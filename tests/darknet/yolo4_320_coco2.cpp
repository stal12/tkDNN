...
int main() {
    ...
    std::string cfg_path  = std::string(TKDNN_PATH) + "/tests/darknet/cfg/yolo4_320_coco2.cfg";
    std::string name_path = std::string(TKDNN_PATH) + "/tests/darknet/names/coco2.names";
